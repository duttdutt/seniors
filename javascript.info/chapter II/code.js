...
//  * @section conversion(explicit)
//  * * toString(), String(), Number(), Boolean(), Array.from(), Object()
//  * @section coercion(implicit/automatic)
...
//  * @section FunctionExpressions
//  * * no name in function expression
//  * * @heading Function Declaration vs Function Expression
 ...
 * 1 argument -> omit the parentheses
 * no arguments -> only parentheses
 * multiline(using curly braces) need curly braces and `return`
 */
const questionArrow = true;
const ask = (q, y, n) => (q ? y() : n());
